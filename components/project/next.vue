  ...
  <div class="next u-container">
    <div class="u-d-f">
      ...
      <div>
        ...
        <nuxt-link :to="{name:'project-slug', params: { slug: project.slug }}" class="large" :aria-label="project.title">
          <img src="" :data-src="`${path}${project.slug}/${project.cover}`" :alt="project.title">
        </nuxt-link>
      </div>
    </div>
  </div>

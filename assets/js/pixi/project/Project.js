import Media from '~/assets/js/pixi/project/Media'
import Covers from '~/assets/js/pixi/project/Covers'
import mediaShader from '~/assets/js/shaders/mediaShader.js'
class Project {
  constructor(stage, path, project, w ,h) {
    this.h = h
    this.w = w
    this.path = path
    this.stage = stage
    this.stage.name = 'project'
  ...
  init() {
    ...
    this.covers = new Covers(this.coversSprite, this.path, this.project, this.w, this.h)
